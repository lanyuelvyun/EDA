...
class VarAnalysis(object):
    ...
    def get_var_odds(self):
        ...
        df_odds = pd.concat([df_odds1, df_odds2], axis=1, keys=["odds_set1", "odds_set2"])
        return df_odds
...
if __name__ == '__main__':
    ...
    for var in var_list:
        ...
        variabledistribution = VarAnalysis(var_name=var, value_list1=df_sub1[var].tolist(),
